...
#define WEIXIN [[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"weixin://"]]
#define QQZONE [[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"mqzone://"]]
#define QQ [[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"mqq://"]]
#define WECHAT [[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:@"wechat://"]]


static LKShareManager * manager = nil;

@interface LKShareManager ()<LKShareViewDelegate>
{
...
@property (nonatomic, strong) LKShareView * shareBackView;
...
- (instancetype)init{
    ...
    if (self) {
        ...
        if (!QQ && WEIXIN) {
            titles = @[@"微信",@"朋友圈",@"新浪微博"];
            imageNames = @[@"share_微信",@"share_朋友圈",@"share_微博"];
        }
        else if (!WEIXIN && QQ) {
            titles = @[@"新浪微博",@"QQ",@"QQ空间"];
            imageNames = @[@"share_微博",@"share_qq",@"share_QQ空间"];
        }
        else if (!(WEIXIN && QQ)) {
            titles = @[@"新浪微博"];
            imageNames = @[@"share_微博"];
            ...
            titles = @[@"微信",@"朋友圈",@"新浪微博",@"QQ",@"QQ空间"];
            imageNames = @[@"share_微信",@"share_朋友圈",@"share_微博",@"share_qq",@"share_QQ空间"];
        }
        self.shareBackView = [[LKShareView alloc] initWithImageNames:imageNames andTitles:titles];
